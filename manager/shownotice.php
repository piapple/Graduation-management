...
<html lang="zh_CN">
  ...
  <div role="main" class="main">
    ...
    <div class="notice">
      <p><span class='glyphicon glyphicon-calendar'><?= $time?></span> <a href="#" onclick="chkdel()" class="text-danger">删除该公告</a></p>
    ...
    <script>
      ...
      function chkdel(){
        if (confirm("确认删除？")) {
          window.location.href="delnotice.php?nid=<?= $content['id']?>";
          return true;
        }else{
          return false;
        }
