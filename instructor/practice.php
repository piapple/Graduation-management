...
<html lang="zh_CN">
  ...
  <div role="navigation" id="foo" class="nav-collapse">
    ...
    <div role="main" class="main">
      ...
      <!-- 内容头部 -->
      <h3><a href='javascript:history.go(-1)' class="glyphicon glyphicon-arrow-left" title="返回"></a> 学生实习信息<small> <?= $u_pname?> <?=$u_pid?></small><small class="pull-right">共<?= $row?>条实习信息</small></h3>
