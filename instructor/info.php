  ...
  <div role="navigation" id="foo" class="nav-collapse">
    ...
    <p class="title">毕业顶岗实习信息平台</p>
      ...
      <ul>
        ...
        <li class="active"><a href="info.php">我的信息</a></li>
            ...
            <form action="renew.php?renewid=<?= $name?>" method="post" onsubmit="return chk(this)">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="tel" class="form-control" name="phone" id="tel" placeholder="<?= $phone?>" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="11">
              </div>
              <div class="form-group">
                <label for="remarks">备注</label>
                <textarea class="form-control" id="remarks" name="remark" rows="6"  placeholder="上海电子信息职业技术学院毕业顶岗实习系统" style="resize: none;"><?= $remark?></textarea>
              </div>
